...
class Collector
{
    ...
    public function createBundle($outputFilePath, $outputFileName, $initialString = null, $finalString = null) {
        ...
        // ЕСЛИ выходной файл еще не существует ИЛИ кэширование выключено (опция "cacheEnable" имеет значение "false")
        if ( !file_exists($outputFile) || !$this->config["cacheEnable"] ) {
