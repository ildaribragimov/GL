			...
			// Если значение НЕ ПУСТОЕ
				...
				switch ( $value['type'] ) {
					...
					case "email":
						...
						// Если E-mail пользователя не прошел проверку на валидацию
						{
							// Формирование сообщения об ошибке
							$errorMsg = 'E-mail указан не верно!';
						}
						// Если E-mail пользователя прошел валидацию
						else {
							// 
							$timeout = 10;
							
							// Здесь необходимо вставить блок кода, проверяющего E-mail пользователя на существование
						}
						// Прерывание выполнения конструкции SWITCH
						break;
